      ...
      <Container>
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-[320px,320px,320px] gap-5 md:gap-6 lg:gap-12">
            <ProjectsCard ind={1} img={magic} title={t('maslahat.m1')} desc={t('projects.p1')} />
            <ProjectsCard ind={2} img={gardens} title={t('maslahat.m2')} desc={t('projects.p2')} />
            <ProjectsCard ind={3} img={fonon} title={t('maslahat.m3')} desc={t('projects.p3')} />
            <ProjectsCard ind={4} img={invento} title={t('maslahat.m4')} desc={t('projects.p4')} />
            <ProjectsCard ind={5} img={school} title={t('maslahat.m5')} desc={t('projects.p5')} />
            <ProjectsCard ind={6} img={boulevard} title={t('maslahat.m6')} desc={t('projects.p6')} />
          </div>
        </div>
      </Container>
    </div>
