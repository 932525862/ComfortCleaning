  ...
  return (
    ...
    >
      <div className="h-[100vh] flex flex-col justify-center max-w-[1320px] px-5 mx-auto text-white relative">
            <h1 data-aos='zoom-in' data-aos-duration='600' data-aos-delay='300' className="text-[40px] sm:text-[58px] md:text-[70px] lg:text-[80px] font-extrabold leading-normal">Comfort </h1>
